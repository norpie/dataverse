//! Modal for creating/editing a match condition's target field.
...
/// Modal for selecting the target field of a match condition.
#[modal(size = Sm)]
pub struct MatchConditionModal {
...
impl MatchConditionModal {
    /// Create a new match condition modal.
    ///
    ...
    /// Create a match condition modal for editing an existing condition.
