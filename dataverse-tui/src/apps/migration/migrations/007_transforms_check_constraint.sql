-- Update transforms CHECK constraint to include new parent_type values.

CREATE TABLE IF NOT EXISTS transforms_new (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    entity_mapping_id INTEGER NOT NULL,
    parent_type TEXT NOT NULL CHECK (parent_type IN ('field_mapping', 'variable', 'match_branch', 'guard_fallback', 'match_default', 'coalesce_chain', 'find_condition')),
