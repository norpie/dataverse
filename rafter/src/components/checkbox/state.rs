...
/// Unique identifier for a Checkbox component instance
...
/// Internal state for a Checkbox component
#[derive(Debug)]
...
/// A checkbox component with reactive state.
///
/// `Checkbox` is a self-contained component that manages its own checked state.
