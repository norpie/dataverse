//! Selection state management for widgets.
//!
//! This module provides shared selection types used by List, Tree, and Table widgets.
//! Selection uses string IDs for stability across item mutations.

use std::collections::HashSet;

/// Selection mode for widgets.
...
///
/// Used by List, Tree, and Table widgets for tracking selected items by their ID.
