//! Scrollbar state trait for widgets that support scrolling.

use super::types::{ScrollbarConfig, ScrollbarDrag, ScrollbarGeometry};

/// Trait for widgets that support scrollbar functionality.
///
/// This trait provides a unified interface for scrollable widgets,
