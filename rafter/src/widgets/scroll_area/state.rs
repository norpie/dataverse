//! ScrollArea widget state.

use std::sync::atomic::{AtomicBool, AtomicUsize, Ordering};
use std::sync::{Arc, RwLock};

use super::super::scrollbar::{ScrollbarConfig, ScrollbarDrag, ScrollbarGeometry, ScrollbarState};
use super::super::traits::ScrollableWidget;

/// Unique identifier for a ScrollArea widget instance.
...
/// Internal state for the ScrollArea widget.
...
/// A scrollable container widget with reactive state.
///
...
impl ScrollableWidget for ScrollArea {
