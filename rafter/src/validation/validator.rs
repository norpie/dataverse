...
///
/// Use the fluent API to chain field validations:
///
/// ```ignore
...
impl Validator {
    ...
    ///
    /// This will skip any async rules. Use `validate_async()` if you have
    ...
    W::Value: Clone + Send + 'static,
{
    ...
    ///
    /// The closure receives the field value and should return `true` if valid.
    ...
    ///
    /// The closure receives the field value and should return a future that
    /// resolves to `true` if valid.
    ...
    fn finalize(self) -> Validator {
        ...
        // Create async validation closure
...
// =============================================================================
// Built-in validation rules for String values (Input widget)
// =============================================================================
...
impl<W: Validatable<Value = String> + Clone + 'static> FieldBuilder<W> {
    ...
    pub fn email(self, msg: impl Into<String>) -> Self {
        ...
        self.rule(
            |v| {
                if v.is_empty() {
                    true // Empty is valid for email check; use required() for non-empty
                } else {
...
// =============================================================================
// Built-in validation rules for bool values (Checkbox widget)
// =============================================================================
...
// =============================================================================
// Built-in validation rules for Option<usize> values (RadioGroup widget)
// =============================================================================
